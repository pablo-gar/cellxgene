...
const _graphBrushWithinRectAction = (type: any, embName: any, brushCoords: any) => async (
  dispatch: any,
  getState: any
) => {
  const { obsCrossfilter: prevObsCrossfilter } = getState();
...
const _graphAllAction = (type: any, embName: any) => async (dispatch: any, getState: any) => {
  const { obsCrossfilter: prevObsCrossfilter } = getState();
...
export const graphBrushCancelAction = (embName: any) => _graphAllAction("graph brush cancel", embName);
export const graphBrushDeselectAction = (embName: any) => _graphAllAction("graph brush deselect", embName);

export const graphLassoStartAction = () =>
  /* no change to crossfilter until a change fires */
  ({ type: "graph lasso start" });

export const graphLassoCancelAction = (embName: any) => _graphAllAction("graph lasso cancel", embName);

export const graphLassoDeselectAction = (embName: any) => _graphAllAction("graph lasso cancel", embName);
...
*/
export const setCellSetFromSelection = (cellSetId: any) => (dispatch: any, getState: any) => {
